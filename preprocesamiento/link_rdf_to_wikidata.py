...
def link_rdf_to_wikidata():
    with open('./preprocesamiento/trends.ttl', 'r', encoding='utf-8') as f:
        lines = f.readlines()

    with open('./preprocesamiento/trends_updated.ttl', 'w', encoding='utf-8') as f:
        for line in lines:
            f.write(line)
